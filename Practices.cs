    ...
    internal class Practices
    {
        ...
        public static void Main()
        {
            try
            {
                ...
                //Console.WriteLine("LastAccessTime time: " + dir.LastAccessTime);
                //Console.WriteLine("Name: " + dir.Name);

                
                 var sDir = dir.GetDirectories();
                 Console.WriteLine("------------list of all dir---------------");
                 foreach (var dd in sDir)
                 {
                      Console.WriteLine("Folder name: "+dd.Name);
                     //if (dd.Name == "books")
                     //{
                     //    var files = new DirectoryInfo(path + "/" + dd.Name).GetFiles();
